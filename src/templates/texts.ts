export const texts = {
  greeting: (name: string): string =>
    `Привет, ${name}!\n\nЯ слежу за землетрясениями в Грузии и пришлю уведомление, когда произойдёт новое.\n\nМеню открывается кнопкой под любым уведомлением или командой /menu. Что ещё умею — /help.`,

  menuPrompt: "Главное меню:",

  // Переходный текст: см. src/bot/keyboard.ts.
  menuRemoved: "Кнопка «☰ Меню» внизу экрана убрана — теперь меню открывается командой /menu.",
